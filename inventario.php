...
// --- LÓGICA DE BÚSQUEDA Y CONSULTA A LA BASE DE DATOS ---
...
<div class="container">
    ...
    <div style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <span style="font-size: 14px; color: #475569;">
            <strong>Instituto Nacional de Ciudad Barrios</strong> - Bachillerato en Desarrollo de Software - Allan Romero
        </span>
    ...
    <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="eliminar_producto.php?id=<?php echo $fila['id']; ?>" 
                       class="btn-eliminar" 
                       onclick="return confirm('¿Estás absolutamente seguro de eliminar el producto: <?php echo htmlspecialchars($fila['nombre_producto']); ?>?');">
                        🗑️ Eliminar
                    </a>
                </td>
            </tr>
        ...
        ?>
            <tr>
                <td colspan="6" style="text-align:center;">No se encontraron productos coincidentes.</td>
            </tr>
        <?php } ?>
        </tbody>
    </table>
